...
export function mapTwilioResponseToInvitationStatus(response: string) {
...
export function formatCancellationMessage(participantName: string, eventName: string) {
  return [
    `Hello ${participantName}`,
    "",
...
export function formatEventCancelledMessage(participantName: string, eventName: string) {
  return [
    `Hello ${participantName}`,
    "",
...
export function formatEventUpdatedMessage(
  participantName: string,
  eventName: string,
  eventDate: string,
  eventLocation: string,
...
export async function sendCancellationSms(to: string, participantName: string, eventName: string) {
  const service = new TwilioSmsService()
  return service.sendSms(to, formatCancellationMessage(participantName, eventName))
}

export async function sendEventCancelledSms(to: string, participantName: string, eventName: string) {
  const service = new TwilioSmsService()
  return service.sendSms(to, formatEventCancelledMessage(participantName, eventName))
}

export async function sendEventUpdatedSms(
  to: string,
  participantName: string,
  eventName: string,
  eventDate: string,
  ...
  return service.sendSms(
    to,
    formatEventUpdatedMessage(participantName, eventName, eventDate, eventLocation, eventTime),
  )
}
